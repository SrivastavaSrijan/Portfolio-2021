...
const MDXComponents = {
  ...
  a: CustomLink,
  p: (props) => (
    <Text as="p" mt={0} color="textPrimary" lineHeight="tall" {...props} />
  ),
  ul: (props) => (
    <Box as="ul" pt={2} pl={4} ml={2} {...props} color="textPrimary" />
  ),
  ol: (props) => (
    <Box as="ol" pt={2} pl={4} ml={2} {...props} color="textPrimary" />
  ),
  li: (props) => <Box as="li" pb={1} {...props} color="textPrimary" />,
};
